...
export default {
  ...
  sse: {
    ...
    intro: 'Connexions SSE réactives avec reconnexion automatique, backoff exponentiel et parsing JSON. Idéal pour les notifications en temps réel, les flux live et le push serveur.',
    quickStart: 'Démarrage rapide',
    quickStartDesc: 'Utilisez le hook réactif pour des connexions SSE simples :',
    createSSE: 'API bas niveau : createSSE',
    createSSEDesc: 'Pour un contrôle total sur la connexion SSE :',
    useSSE: 'Hook réactif : useSSE',
    useSSEDesc: 'Hook de haut niveau avec gestion automatique du cycle de vie :',
    connectionState: 'État de connexion',
    connectionStateDesc: 'Tout l\'état est exposé via des Pulses réactifs :',
    customEvents: 'Événements personnalisés',
    customEventsDesc: 'Écoutez des événements SSE nommés au-delà du "message" par défaut :',
    autoReconnect: 'Reconnexion automatique',
    autoReconnectDesc: 'Backoff exponentiel avec jitter pour une reconnexion fiable :',
    errorHandling: 'Gestion des erreurs',
    errorHandlingDesc: 'Toutes les erreurs sont encapsulées dans SSEError avec des codes structurés :',
    errorCodes: 'Codes d\'erreur',
    description: 'Description',
    when: 'Quand',
    errorConnectFailed: 'Échec de connexion',
    errorConnectFailedWhen: 'EventSource ne peut pas se connecter à l\'URL',
    errorTimeout: 'Délai de connexion dépassé',
    errorTimeoutWhen: 'La tentative de connexion a dépassé le délai',
    errorMaxRetries: 'Tentatives épuisées',
    errorMaxRetriesWhen: 'Toutes les tentatives de reconnexion ont échoué',
    errorClosed: 'Connexion fermée',
    errorClosedWhen: 'Le serveur a fermé la connexion',
    jsonParsing: 'Parsing JSON',
    jsonParsingDesc: 'Les messages sont automatiquement parsés en JSON par défaut :',
    fullExample: 'Exemple complet',
    fullExampleDesc: 'Un flux de notifications en temps réel avec gestion de la reconnexion :'
  },

  // Persistence page
  persistence: {
    title: '💾 Persistence',
    intro: 'Stockage automatique de l\'état avec adaptateurs modulaires. Persistez votre store dans localStorage, sessionStorage, IndexedDB ou des backends personnalisés avec debouncing et sérialisation sélective.',
    quickStart: 'Démarrage rapide',
    quickStartDesc: 'Ajoutez la persistance à n\'importe quel store Pulse :',
    storageAdapters: 'Adaptateurs de stockage',
    storageAdaptersDesc: 'Choisissez le bon backend de stockage pour votre cas d\'utilisation :',
    withPersistence: 'API withPersistence',
    withPersistenceDesc: 'Connectez un store à un adaptateur de stockage :',
    optionsReference: 'Référence des options',
    optionsReferenceDesc: 'Toutes les options disponibles pour withPersistence :',
    option: 'Option',
    defaultValue: 'Par défaut',
    description: 'Description',
    selectivePersistence: 'Persistance sélective',
    selectivePersistenceDesc: 'Contrôlez quels champs sont persistés :',
    indexedDB: 'Adaptateur IndexedDB',
    indexedDBDesc: 'Pour les gros jeux de données dépassant les limites de localStorage :',
    errorHandling: 'Gestion des erreurs',
    errorHandlingDesc: 'Toutes les erreurs sont encapsulées dans PersistenceError :',
    testing: 'Tests avec l\'adaptateur mémoire',
    testingDesc: 'Utilisez l\'adaptateur mémoire pour des tests isolés :',
    fullExample: 'Exemple complet',
    fullExampleDesc: 'Store avec sauvegarde automatique et restauration au démarrage :'
  },

  // i18n page
  i18n: {
    title: '🌍 Internationalisation (i18n)',
    intro: 'Internationalisation réactive avec changement de langue, interpolation, pluralisation et gestion des clés manquantes. Entièrement intégré à la réactivité Pulse.',
    quickStart: 'Démarrage rapide',
    quickStartDesc: 'Créez une instance i18n avec des messages :',
    translationFunction: 'Fonction de traduction',
    translationFunctionDesc: 'Utilisez t() pour traduire des clés avec interpolation optionnelle :',
    pluralization: 'Pluralisation',
    pluralizationDesc: 'Utilisez tc() pour les traductions basées sur le nombre avec des valeurs séparées par des pipes :',
    localeSwitching: 'Changement de langue',
    localeSwitchingDesc: 'La locale est un Pulse réactif qui met à jour toutes les traductions automatiquement :',
    addingMessages: 'Ajout de messages',
    addingMessagesDesc: 'Ajoutez dynamiquement des traductions à l\'exécution :',
    fallbackLocale: 'Langue de secours',
    fallbackLocaleDesc: 'Les clés manquantes utilisent la langue de secours :',
    missingKeyHandler: 'Gestionnaire de clés manquantes',
    missingKeyHandlerDesc: 'Gestion personnalisée des clés de traduction manquantes :',
    modifiers: 'Modificateurs',
    modifiersDesc: 'Transformez le texte traduit avec des modificateurs personnalisés :',
    fullExample: 'Exemple complet',
    fullExampleDesc: 'Une application multilingue avec changement de langue réactif :'
  },

  // Animation page
  animation: {
    title: '🎬 Animation',
    intro: 'Wrapper de l\'API Web Animations avec réactivité Pulse, animations prédéfinies et support automatique du mouvement réduit. Compatible SSR avec fallbacks sans surcoût.',
    quickStart: 'Démarrage rapide',
    quickStartDesc: 'Animez des éléments avec une API simple :',
    configuration: 'Configuration',
    configurationDesc: 'Configurez les paramètres d\'animation globaux :',
    presetAnimations: 'Animations prédéfinies',
    presetAnimationsDesc: 'Presets d\'animation intégrés pour les transitions courantes :',
    customKeyframes: 'Keyframes personnalisés',
    customKeyframesDesc: 'Utilisez les keyframes de l\'API Web Animations pour un contrôle total :',
    listAnimations: 'Animations de listes',
    listAnimationsDesc: 'Animations échelonnées pour des listes d\'éléments :',
    transitions: 'Transitions',
    transitionsDesc: 'Animez entre deux états :',
    useAnimationHook: 'Hook useAnimation',
    useAnimationHookDesc: 'Contrôle d\'animation réactif avec lecture/pause/inversion :',
    reducedMotion: 'Mouvement réduit',
    reducedMotionDesc: 'Respecte automatiquement prefers-reduced-motion pour l\'accessibilité :',
    fullExample: 'Exemple complet',
    fullExampleDesc: 'Liste de cartes animées avec transitions d\'entrée/sortie :'
  },

  // Portal page
  portal: {
    title: '🚪 Portal',
    intro: 'Rendez des enfants dans un emplacement DOM différent. Essentiel pour les modales, tooltips, toasts et menus déroulants qui doivent sortir des contraintes d\'overflow ou de z-index du parent.',
    quickStart: 'Démarrage rapide',
    quickStartDesc: 'Rendez du contenu en dehors de la hiérarchie parente :',
    portalApi: 'API portal()',
    portalApiDesc: 'Référence complète de l\'API de la fonction portal :',
    staticContent: 'Contenu statique',
    staticContentDesc: 'Portal avec des enfants statiques :',
    reactiveContent: 'Contenu réactif',
    reactiveContentDesc: 'Portal avec une fonction réactive qui se met à jour automatiquement :',
    movingPortals: 'Portals mobiles',
    movingPortalsDesc: 'Changez la cible du portal dynamiquement :',
    multiplePortals: 'Portals multiples',
    multiplePortalsDesc: 'Utilisez des clés pour gérer plusieurs portals vers la même cible :',
    modalPattern: 'Pattern Modale',
    modalPatternDesc: 'Modale accessible complète utilisant portal :',
    toastNotifications: 'Notifications Toast',
    toastNotificationsDesc: 'Un système de notifications toast utilisant les portals :',
    errorBoundary: 'Limite d\'erreur',
    errorBoundaryDesc: 'Capturez et gérez les erreurs de rendu avec élégance :',
    cleanup: 'Nettoyage et cycle de vie',
    cleanupDesc: 'Cycle de vie du portal et nettoyage approprié :'
  },

  // Service Worker page
  sw: {
    title: '⚙️ Service Worker',
    intro: 'Enregistrez et gérez les service workers avec un état de cycle de vie réactif, des notifications de mise à jour et des stratégies de cache. Créez des Progressive Web Apps fonctionnant hors ligne.',
    quickStart: 'Démarrage rapide',
    quickStartDesc: 'Enregistrez un service worker avec suivi du cycle de vie :',
    registrationOptions: 'Options d\'enregistrement',
    registrationOptionsDesc: 'Toutes les options disponibles pour registerServiceWorker :',
    option: 'Option',
    defaultValue: 'Par défaut',
    description: 'Description',
    reactiveState: 'État réactif',
    reactiveStateDesc: 'Tout l\'état du cycle de vie est exposé via des Pulses réactifs :',
    updateHandling: 'Gestion des mises à jour',
    updateHandlingDesc: 'Détectez et appliquez les mises à jour du service worker :',
    cacheStrategies: 'Stratégies de cache',
    cacheStrategiesDesc: 'Stratégies de cache intégrées pour différents types de ressources :',
    precaching: 'Pré-cache',
    precachingDesc: 'Pré-cachez les ressources critiques pendant l\'installation du service worker :',
    offlineSupport: 'Support hors ligne',
    offlineSupportDesc: 'Pattern complet d\'application fonctionnant hors ligne :',
    errorHandling: 'Gestion des erreurs',
    errorHandlingDesc: 'Gérez les erreurs d\'enregistrement et de mise à jour du service worker :',
    fullExample: 'Exemple complet',
    fullExampleDesc: 'PWA avec notifications de mise à jour et support hors ligne :'
  },
