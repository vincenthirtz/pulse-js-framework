...
export default {
  ...
  benchmarks: {
    ...
    store: 'Store',
    form: 'Form',
    routerUtils: 'Router Utilities',
    context: 'Context API',
    a11y: 'Accessibility',

    // CI Results
    ciResults: 'CI Benchmark Results',
    ciLoading: 'Loading latest CI results...',
    ciNoData: 'No CI benchmark data available yet.',
    ciUnavailable: 'CI results are not currently available. Results will appear after the next push to develop.',
    ciLastRun: 'Last run',
    ...
    ciOpsPerSec: 'Ops/sec',
    ciStdDev: 'Std Dev',
    ciNote: 'Results from GitHub Actions CI on ubuntu-latest, Node.js 20.',
  ...
  serverComponents: {
    ...
    intro: 'React Server Components-style architecture for Pulse. Build hybrid applications with component-level code splitting, Server Actions, and comprehensive security features including CSRF protection and rate limiting.'
  }
};
