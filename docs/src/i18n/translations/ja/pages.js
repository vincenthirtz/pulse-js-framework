...
export default {
  ...
  sse: {
    ...
    intro: 'リアクティブなSSE接続。自動再接続、指数バックオフ、JSONパースをサポート。リアルタイム通知、ライブフィード、サーバープッシュに最適。',
    quickStart: 'クイックスタート',
    quickStartDesc: 'リアクティブフックでシンプルなSSE接続を作成:',
    createSSE: 'ローレベルAPI: createSSE',
    createSSEDesc: 'SSE接続を完全に制御:',
    useSSE: 'リアクティブフック: useSSE',
    useSSEDesc: 'ライフサイクル自動管理の高レベルフック:',
    connectionState: '接続状態',
    connectionStateDesc: 'すべての状態はリアクティブなPulseとして公開:',
    customEvents: 'カスタムイベント',
    customEventsDesc: 'デフォルトの"message"以外の名前付きSSEイベントをリッスン:',
    autoReconnect: '自動再接続',
    autoReconnectDesc: '信頼性の高い再接続のための指数バックオフとジッター:',
    errorHandling: 'エラー処理',
    errorHandlingDesc: 'すべてのエラーは構造化コード付きのSSEErrorにラップ:',
    errorCodes: 'エラーコード',
    description: '説明',
    when: '発生条件',
    errorConnectFailed: '接続失敗',
    errorConnectFailedWhen: 'EventSourceがURLに接続できない',
    errorTimeout: '接続タイムアウト',
    errorTimeoutWhen: '接続試行がタイムアウトを超過',
    errorMaxRetries: 'リトライ上限到達',
    errorMaxRetriesWhen: 'すべての再接続試行が失敗',
    errorClosed: '接続終了',
    errorClosedWhen: 'サーバーが接続を閉じた',
    jsonParsing: 'JSONパース',
    jsonParsingDesc: 'メッセージはデフォルトで自動的にJSONとしてパース:',
    fullExample: '完全な例',
    fullExampleDesc: '再接続処理付きのリアルタイム通知ストリーム:'
  },

  // Persistence page
  persistence: {
    title: '💾 Persistence',
    intro: 'プラガブルアダプターによる自動状態保存。localStorage、sessionStorage、IndexedDB、またはカスタムバックエンドにストアを永続化。デバウンスと選択的シリアライズをサポート。',
    quickStart: 'クイックスタート',
    quickStartDesc: '任意のPulseストアに永続化を追加:',
    storageAdapters: 'ストレージアダプター',
    storageAdaptersDesc: 'ユースケースに適したストレージバックエンドを選択:',
    withPersistence: 'withPersistence API',
    withPersistenceDesc: 'ストアをストレージアダプターに接続:',
    optionsReference: 'オプションリファレンス',
    optionsReferenceDesc: 'withPersistenceで使用可能なすべてのオプション:',
    option: 'オプション',
    defaultValue: 'デフォルト',
    description: '説明',
    selectivePersistence: '選択的永続化',
    selectivePersistenceDesc: 'どのフィールドを永続化するか制御:',
    indexedDB: 'IndexedDBアダプター',
    indexedDBDesc: 'localStorageの制限を超える大規模データセット用:',
    errorHandling: 'エラー処理',
    errorHandlingDesc: 'すべてのエラーはPersistenceErrorにラップ:',
    testing: 'メモリアダプターでテスト',
    testingDesc: '分離テスト用のメモリアダプターを使用:',
    fullExample: '完全な例',
    fullExampleDesc: '起動時に復元する自動保存ストア:'
  },

  // i18n page
  i18n: {
    title: '🌍 国際化 (i18n)',
    intro: 'ロケール切替、補間、複数形、欠落キー処理を備えたリアクティブな国際化。Pulseのリアクティビティと完全に統合。',
    quickStart: 'クイックスタート',
    quickStartDesc: 'メッセージ付きのi18nインスタンスを作成:',
    translationFunction: '翻訳関数',
    translationFunctionDesc: 't()でオプションの補間付きキーを翻訳:',
    pluralization: '複数形',
    pluralizationDesc: 'tc()でパイプ区切り値によるカウントベースの翻訳:',
    localeSwitching: 'ロケール切替',
    localeSwitchingDesc: 'ロケールはリアクティブなPulseで、すべての翻訳を自動更新:',
    addingMessages: 'メッセージの追加',
    addingMessagesDesc: '実行時に動的に翻訳を追加:',
    fallbackLocale: 'フォールバックロケール',
    fallbackLocaleDesc: '欠落キーはフォールバックロケールを使用:',
    missingKeyHandler: '欠落キーハンドラー',
    missingKeyHandlerDesc: '欠落した翻訳キーのカスタム処理:',
    modifiers: '修飾子',
    modifiersDesc: 'カスタム修飾子で翻訳テキストを変換:',
    fullExample: '完全な例',
    fullExampleDesc: 'リアクティブなロケール切替を備えた多言語アプリケーション:'
  },

  // Animation page
  animation: {
    title: '🎬 Animation',
    intro: 'Pulseリアクティビティ、プリセットアニメーション、モーション軽減自動サポート付きのWeb Animations APIラッパー。オーバーヘッドゼロのフォールバックでSSR対応。',
    quickStart: 'クイックスタート',
    quickStartDesc: 'シンプルなAPIで要素をアニメーション:',
    configuration: '設定',
    configurationDesc: 'グローバルアニメーション設定を構成:',
    presetAnimations: 'プリセットアニメーション',
    presetAnimationsDesc: '一般的なトランジション用の組み込みアニメーションプリセット:',
    customKeyframes: 'カスタムキーフレーム',
    customKeyframesDesc: 'Web Animations APIキーフレームで完全制御:',
    listAnimations: 'リストアニメーション',
    listAnimationsDesc: '要素リスト用のスタガードアニメーション:',
    transitions: 'トランジション',
    transitionsDesc: '2つの状態間をアニメーション:',
    useAnimationHook: 'useAnimationフック',
    useAnimationHookDesc: '再生/一時停止/逆再生のリアクティブアニメーション制御:',
    reducedMotion: 'モーション軽減',
    reducedMotionDesc: 'アクセシビリティのためprefers-reduced-motionを自動的に尊重:',
    fullExample: '完全な例',
    fullExampleDesc: '入場/退場トランジション付きのアニメーションカードリスト:'
  },

  // Portal page
  portal: {
    title: '🚪 Portal',
    intro: '異なるDOM位置に子要素をレンダリング。親のoverflow制約やz-index制約から抜け出す必要があるモーダル、ツールチップ、トースト、ドロップダウンに不可欠。',
    quickStart: 'クイックスタート',
    quickStartDesc: '親の階層外にコンテンツをレンダリング:',
    portalApi: 'portal() API',
    portalApiDesc: 'portal関数の完全なAPIリファレンス:',
    staticContent: '静的コンテンツ',
    staticContentDesc: '静的な子要素を持つPortal:',
    reactiveContent: 'リアクティブコンテンツ',
    reactiveContentDesc: '自動更新するリアクティブ関数を持つPortal:',
    movingPortals: '移動するPortal',
    movingPortalsDesc: 'Portalのターゲットを動的に変更:',
    multiplePortals: '複数のPortal',
    multiplePortalsDesc: 'キーを使って同じターゲットへの複数のPortalを管理:',
    modalPattern: 'モーダルパターン',
    modalPatternDesc: 'portalを使用した完全なアクセシブルモーダル:',
    toastNotifications: 'トースト通知',
    toastNotificationsDesc: 'ポータルを使用したトースト通知システム:',
    errorBoundary: 'エラーバウンダリ',
    errorBoundaryDesc: 'レンダリングエラーを優雅にキャッチして処理:',
    cleanup: 'クリーンアップとライフサイクル',
    cleanupDesc: 'Portalのライフサイクルと適切なクリーンアップ:'
  },

  // Service Worker page
  sw: {
    title: '⚙️ Service Worker',
    intro: 'リアクティブなライフサイクル状態、更新通知、キャッシング戦略でService Workerを登録・管理。オフライン対応のProgressive Web Appsを構築。',
    quickStart: 'クイックスタート',
    quickStartDesc: 'ライフサイクル監視付きのService Workerを登録:',
    registrationOptions: '登録オプション',
    registrationOptionsDesc: 'registerServiceWorkerで使用可能なすべてのオプション:',
    option: 'オプション',
    defaultValue: 'デフォルト',
    description: '説明',
    reactiveState: 'リアクティブ状態',
    reactiveStateDesc: 'すべてのライフサイクル状態はリアクティブなPulseとして公開:',
    updateHandling: '更新処理',
    updateHandlingDesc: 'Service Workerの更新を検出して適用:',
    cacheStrategies: 'キャッシュ戦略',
    cacheStrategiesDesc: '異なるリソースタイプ用の組み込みキャッシュ戦略:',
    precaching: 'プリキャッシュ',
    precachingDesc: 'Service Workerのインストール中に重要なリソースをプリキャッシュ:',
    offlineSupport: 'オフラインサポート',
    offlineSupportDesc: '完全なオフライン対応アプリケーションパターン:',
    errorHandling: 'エラー処理',
    errorHandlingDesc: 'Service Workerの登録および更新エラーを処理:',
    fullExample: '完全な例',
    fullExampleDesc: '更新通知とオフラインサポートを備えたPWA:'
  },
