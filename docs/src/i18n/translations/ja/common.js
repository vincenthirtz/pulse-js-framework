/**
 * Japanese translations - Common UI elements
 */
...
export default {
  ...
  nav: {
    ...
    guides: '📝 ガイド',
    gettingStarted: '🚀 はじめに',
    gettingStartedDesc: 'インストールと最初のステップ',
    ...
    serverComponentsDesc: 'React スタイルのサーバーコンポーネントとアクション',    ssrDesc: 'サーバーサイドレンダリングとハイドレーション',
    devtools: '🛠️ DevTools',
    devtoolsDesc: 'デバッグとプロファイリング',
    internals: '⚙️ 内部構造',
    internalsDesc: 'アルゴリズムと実装',
    accessibility: '♿ アクセシビリティ',
    accessibilityDesc: 'a11y機能とベストプラクティス',
    debugging: '🔍 デバッグ',
    debuggingDesc: 'ツールとトラブルシューティング',
    security: '🔒 セキュリティ',
    securityDesc: 'XSS防止と安全なパターン',
    performance: '⚡ パフォーマンス',
    performanceDesc: '最適化テクニック',
    errorHandling: '🛡️ エラー処理',
    errorHandlingDesc: 'エラーパターンとリカバリー',
    mobile: '📱 モバイル',
  ...
  code: {
    ...
    zeroDependencies: '依存関係ゼロ',
    buildStep: 'ビルドステップ',
    noBuildRequired: 'ビルド不要',
    bundleSize: 'バンドルサイズ',
    sourceCode: 'ソースコード',
    liveDemo: 'ライブデモ'
  },
