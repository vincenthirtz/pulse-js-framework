...
export default {
  ...
  ssr: {
    ...
    intro: 'SSR kaj hidratado por Pulse aplikaĵoj.',
    quickStart: 'Rapida Komenco',
    quickStartDesc: 'Pulse provizas enkonstruitan SSR por renderi HTML ĉe la servilo kaj hidratadi ĉe la kliento.',
    serverSetup: 'Servila Agordo',
    serverSetupDesc: 'Uzu renderToString en Node.js/Express servilo:',
    clientHydration: 'Klienta Hidratado',
    clientHydrationDesc: 'Hidratadu servilrenderiĝitan HTML ĉe la kliento:',
    stateSerialization: 'Stato-Serialigado',
    stateSerializationDesc: 'Transigi staton de servilo al kliento:',
    serializeState: 'Serialigi staton',
    deserializeState: 'Desaligi staton',
    restoreState: 'Restarigi staton',
    getSSRState: 'Akiri SSR staton',
    modeDetection: 'Reĝima Detekto',
    modeDetectionDesc: 'Detekti ĉu funkciante en SSR aŭ hidratada reĝimo:',
    isSSR: 'Kontroli SSR reĝimon',
    isHydrating: 'Kontroli hidratadon',
    ssrSafeEffects: 'SSR-sekuraj Efikoj',
    ssrSafeEffectsDesc: 'Efikoj rulas unufoje sen abonoj en SSR reĝimo:',
    asyncData: 'Nesinkronaj Datumoj',
    asyncDataDesc: 'useAsync aŭtomate integriĝas kun SSR:',
    architecture: 'SSR Arkitekturo',
    architectureDesc: 'Moduloj formantaj la SSR sistemon:',
    module: 'Modulo',
    purpose: 'Celo',
    ...
    howItWorksDesc: 'Ĉiu paŝo de la SSR procezo:',
    step1: 'Servila Renderado',
    step1Desc: 'renderToString() kreas izolitan kuntekston, uzas MockDOMAdapter',
    step2: 'Nesinkrona Kolektado',
    step2Desc: 'Unua renderado kolektas useAsync operaciojn',
    step3: 'Datumricevado',
    step3Desc: 'Atendas ĉiujn nesinkronajn operaciojn (kun tempolimo)',
    step4: 'Re-renderado',
    step4Desc: 'Dua renderado kun solvitaj datumoj',
    step5: 'Serialigado',
    step5Desc: 'MockNode arbo → HTML ĉeno',
    step6: 'Stato-Transsendo',
    step6Desc: 'Serialigas staton por kliento',
    step7: 'Hidratado',
    step7Desc: 'Kliento konektas aŭskultantojn al ekzistanta DOM',
    apiReference: 'API Referenco',
    renderToString: 'renderToString',
    renderToStringDesc: 'Renderas komponanton kiel HTML ĉenon (nesinkrone, atendas datumojn)',
    renderToStringSync: 'renderToStringSync',
    renderToStringSyncDesc: 'Renderas sinkrone (sen nesinkrona atendado)',
    hydrate: 'hydrate',
    hydrateDesc: 'Hidratadas servilrenderiĝitan HTML',
    serializeStateApi: 'serializeState',
    serializeStateApiDesc: 'Serialigas staton (traktas Date, undefined, XSS eskapadon)',
    deserializeStateApi: 'deserializeState',
    deserializeStateApiDesc: 'Desaliigas staton (restarigas Date objektojn)',
    fullExample: 'Plena Ekzemplo',
    fullExampleDesc: 'Kompleta servila kaj klienta agordo uzante SSR:',
    serverCode: 'Servila Kodo',
    clientCode: 'Klienta Kodo',
    bestPractices: 'Plej Bonaj Praktikoj',
    bestPractice1: 'Evitu foliumilajn API-ojn en SSR',
    bestPractice1Desc: 'Ne uzu window, document aŭ localStorage en servila kodo. Kontrolu per isSSR().',
    bestPractice2: 'Agordu tempolimojn por nesinkronaj operacioj',
    bestPractice2Desc: 'Agordu raciajn tempolimojn por eviti blokitajn petojn.',
    bestPractice3: 'Traktu stato-serialigadon',
    bestPractice3Desc: 'Uzu la provizitajn helpilojn por konservi Date objektojn kaj undefined.',
    bestPractice4: 'Testu hidratadajn miskongruojn',
    bestPractice4Desc: 'Certigu ke servila kaj klienta renderado kongruas.',
    bestPractice5: 'Konsideru fluadon',
    bestPractice5Desc: 'Por grandaj paĝoj, konsideru fluan SSR por plibonigi TTFB.',
    troubleshooting: 'Problemsolvado',
    issue1: 'Hidratada miskongruo',
    issue1Desc: 'Klienta HTML malsamas de servila HTML. Certigu determinisman renderadon sur ambaŭ.',
    issue2: 'window is not defined',
    issue2Desc: 'Uzante foliumilajn API-ojn en servila kodo. Envolvu per isSSR() kontrolo.',
    issue3: 'Nesinkronaj datumoj mankas',
    issue3Desc: 'Certigu waitForAsync: true kaj agordu racian tempolimon.',
