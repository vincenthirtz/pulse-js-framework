...
export default {
  ...
  coreConcepts: {
    title: '💡 Kernkonzepte',
    intro: 'Pulse basiert auf vier Kernkonzepten: Pulses (reaktiver Zustand), Effekte (Nebenwirkungen), DOM-Helpers und die optionale .pulse-DSL.',
    ...
    computedDesc: 'Abgeleitete Werte, die sich automatisch aktualisieren.',
    domHelpers: 'DOM-Helpers',
    domHelpersDesc: 'Erstellen Sie DOM-Elemente mit CSS-Selektor-Syntax.',
    reactiveBindings: 'Reaktive Bindungen',
    conditionalList: 'Bedingtes und Listen-Rendering',
    pulseDsl: '.pulse-DSL',
    pulseDslDesc: 'Die optionale DSL bietet eine sauberere Syntax für Komponenten.',
  ...
  security: {
    ...
    securityChecklist: 'Sicherheits-Checkliste',
  ...
  performance: {
    ...
    batchingUpdates: 'Updates bündeln',
    batchingUpdatesDesc: 'Bündeln Sie mehrere Zustandsänderungen, um Zwischen-Rerenders zu vermeiden.',
    ...
    lazyLoadingRoutes: 'Lazy Loading von Routen',
    lazyLoadingRoutesDesc: 'Teilen Sie Ihre App in Chunks auf, die bei Bedarf geladen werden.',
    avoidUnnecessaryReactivity: 'Unnötige Reaktivität vermeiden',
    avoidUnnecessaryReactivityDesc: 'Nicht alles muss reaktiv sein.',
    ...
    performanceMonitoringDesc: 'Verwenden Sie das DevTools-Modul zur Performance-Überwachung.',
    performanceChecklist: 'Performance-Checkliste',
  ...
  errorHandling: {
    ...
    effectErrorHandling: 'Fehlerbehandlung in Effekten',
    effectErrorHandlingDesc: 'Effekte können fehlschlagen. Behandeln Sie Fehler elegant.',
    perEffectHandler: 'Error-Handler pro Effekt',
    globalEffectHandler: 'Globaler Error-Handler für Effekte',
    asyncErrorHandling: 'Async-Fehlerbehandlung',
    asyncErrorHandlingDesc: 'Das Async-Modul bietet integriertes Fehlerzustands-Management.',
    formValidation: 'Formular-Validierungsfehler',
    formValidationDesc: 'Behandeln Sie Formularvalidierung mit dem Form-Modul.',
    routerErrorHandling: 'Router-Fehlerbehandlung',
    routerErrorHandlingDesc: 'Behandeln Sie Navigations- und Routen-Ladefehler.',
    errorBoundaries: 'Error Boundaries',
    errorBoundariesDesc: 'Begrenzen Sie Fehler, um App-weite Abstürze zu verhindern.',
    errorLogging: 'Fehler-Logging und Reporting',
    errorLoggingDesc: 'Integrieren Sie Fehlertracking-Dienste.',
    gracefulDegradation: 'Graceful Degradation',
    gracefulDegradationDesc: 'Muster zur Aufrechterhaltung der Funktionalität bei Teilausfällen.',
    errorPatternsSummary: 'Zusammenfassung der Fehlerbehandlungsmuster',
    nextApiReference: 'Weiter: API-Referenz'
  },
  ...
  mobile: {
    ...
    gettingStartedDesc: 'Richten Sie Ihre mobile Entwicklungsumgebung ein.',
    platformDetection: 'Plattformerkennung',
    platformDetectionDesc: 'Erkennen Sie die aktuelle Plattform und passen Sie das Verhalten an.',
    nativeStorage: 'Nativer Speicher',
    nativeStorageDesc: 'Persistenter Speicher, der auf Web und nativ funktioniert.',
    deviceInfo: 'Geräteinformationen',
    deviceInfoDesc: 'Zugriff auf Geräteinformationen und Netzwerkstatus.',
    nativeUi: 'Native UI',
    nativeUiDesc: 'Zugriff auf native UI-Elemente wie Toasts und Vibration.',
    appLifecycle: 'App-Lebenszyklus',
    appLifecycleDesc: 'Behandeln Sie Pause-, Wiederaufnahme- und Zurück-Taste-Ereignisse.',
    buildingApps: 'Apps erstellen',
    buildingAppsDesc: 'Erstellen und verpacken Sie Ihre App zur Verteilung.',
    overview: 'Übersicht',
    overviewDesc: 'Pulse Mobile ermöglicht es Ihnen, Ihre Web-App in eine native mobile App zu verpacken - ohne externe Abhängigkeiten.',
    features: {
      zeroDeps: '🚀 Keine Abhängigkeiten',
      zeroDepsDesc: 'Reiner nativer Code, keine npm-Pakete erforderlich',
      singleCodebase: '📦 Eine Codebasis',
      singleCodebaseDesc: 'Dieselbe Pulse-App läuft auf Web, Android und iOS',
      nativePerf: '⚡ Native Performance',
      nativePerfDesc: 'WebView mit Hardware-Beschleunigung',
      nativeApis: '🔧 Native APIs',
      nativeApisDesc: 'Zugriff auf Speicher, Geräteinformationen, Zwischenablage und mehr'
    },
    ...
    nextChangelog: 'Weiter: Änderungsprotokoll'
  },
