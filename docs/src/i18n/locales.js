...
// SVG flag templates (16x12 viewBox for consistent sizing, aria-hidden for decorative icons)
const flags = {
  // UK - Union Jack (simplified)
  en: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 60 30" width="20" height="12" aria-hidden="true">
  ...
  fr: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 3 2" width="20" height="12" aria-hidden="true">
  ...
  es: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 3 2" width="20" height="12" aria-hidden="true">
    <rect fill="#AA151B" width="3" height="2"/>
    <rect fill="#F1BF00" y="0.5" width="3" height="1"/>
  </svg>`,
  // Germany - Black Red Yellow
  de: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 5 3" width="20" height="12" aria-hidden="true">
  ...
  ja: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 3 2" width="20" height="12" aria-hidden="true">
    <rect fill="#fff" width="3" height="2"/>
    <circle fill="#BC002D" cx="1.5" cy="1" r="0.6"/>
  </svg>`,
  // Brazil - Green with yellow diamond
  pt: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 14" width="20" height="12" aria-hidden="true">
  ...
  is: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 25 18" width="20" height="12" aria-hidden="true">
  ...
  eo: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 3 2" width="20" height="12" aria-hidden="true">
