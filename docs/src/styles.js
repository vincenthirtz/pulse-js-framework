...
/* Content wrapper for main + TOC sidebar */
.content-wrapper {
  flex: 1;
  display: flex;
  position: relative;
...
.code-header {
  ...
  background: var(--bg-light);
  font-size: 0.85em;
  color: var(--text); /* WCAG AA: use main text color for better contrast */
  border-bottom: 1px solid var(--border);
}
...
.hljs-comment { color: #8b9dc3; font-style: italic; } /* WCAG AA: 5.1:1 on #0d1117 */
...
[data-theme="light"] .hljs-comment { color: #57606a; } /* WCAG AA: 5.3:1 on #f1f5f9 */
...
.other-fw {
  ...
  background: var(--bg);
  border-radius: 20px;
  color: var(--text); /* WCAG AA: improved contrast */
}
...
.showroom-select-wrapper label {
  font-size: 0.9em;
  font-weight: 600;
  color: var(--text-muted);
}

.showroom-select-wrapper select {
  padding: 10px 14px;
  border-radius: 8px;
  border: 1px solid var(--border);
  background: var(--card);
...
.showroom-select-wrapper select:focus {
  outline: none;
  border-color: var(--primary);
...
.showroom-iframe-wrapper iframe {
  width: 100%;
  height: 600px;
  border: none;
  display: block;
...
.showroom-info .example-features {
  list-style: none;
  margin-bottom: 20px;
}

.showroom-info .example-features li {
  padding: 3px 0;
  font-size: 0.9em;
  color: var(--text-muted);
}

.showroom-info .example-features li::before {
  content: "\\2713 ";
  color: var(--success);
  margin-right: 6px;
}
